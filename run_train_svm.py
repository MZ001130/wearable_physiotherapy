#!/usr/bin/env python3
"""
End-to-end SVM training: load data -> preprocess -> features -> train -> save results.
Run from project root: python run_train_svm.py
"""
import os
import sys
import time
...
def main() -> None:
    ...
    print("Step 4: Train SVM (subject-independent split)...")
    ...
    # SVM benefits significantly from scaling
    clf = make_pipeline(StandardScaler(), SVC(random_state=RANDOM_STATE))
    ...
    print(f"  Results in {RESULTS_DIR}/ (confusion_matrix_svm.png, metrics_svm.csv, model_svm.joblib)")
